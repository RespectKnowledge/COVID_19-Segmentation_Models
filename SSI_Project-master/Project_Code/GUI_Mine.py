...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Depression Project for classiification"))
        #----------------------------------------------------------------------
        self.LB_ImageTitle.setToolTip(_translate("MainWindow", "Depression tilte"))
        self.LB_ImageTitle.setStatusTip(_translate("MainWindow", "Depression tilte"))
        self.LB_ImageTitle.setWhatsThis(_translate("MainWindow", "Depression tilte"))
        self.LB_ImageTitle.setText(_translate("MainWindow", "Depression data"))
        #--------------------------------------------------------------------------------------------------
...
#        self.CB_Platform.setItemText(1, _translate("MainWindow", "PyTorch"))
        #--------------------------------------------------------------------------------------------------
        self.LB_Hausdorff.setToolTip(_translate("MainWindow", "Accuracy"))
        self.LB_Hausdorff.setStatusTip(_translate("MainWindow", "Accuracy"))
        self.LB_Hausdorff.setWhatsThis(_translate("MainWindow", "Accuracy"))
        self.LB_Hausdorff.setText(_translate("MainWindow", "Accuracy"))   
        #--------------------------------------------------------------------------------------------------
        self.LB_HausdorffValue.setText(_translate("MainWindow", "0"))
        #--------------------------------------------------------------------------------------------------
        self.LB_Dice.setToolTip(_translate("MainWindow", "Precision"))
        self.LB_Dice.setStatusTip(_translate("MainWindow", "Precision"))
        self.LB_Dice.setWhatsThis(_translate("MainWindow", "Precision"))
        self.LB_Dice.setText(_translate("MainWindow", "Precision"))
        #--------------------------------------------------------------------------------------------------
        self.LB_DiceValue.setText(_translate("MainWindow", "0"))
        #--------------------------------------------------------------------------------------------------
        self.LB_Jaccard.setToolTip(_translate("MainWindow", "Recall"))
        self.LB_Jaccard.setStatusTip(_translate("MainWindow", "Recall"))
        self.LB_Jaccard.setWhatsThis(_translate("MainWindow", "Recall"))
        self.LB_Jaccard.setText(_translate("MainWindow", "Recall"))
        #--------------------------------------------------------------------------------------------------
        ...
        #--------------------------------------------------------------------------------------------------        
        self.LB_Pearson.setToolTip(_translate("MainWindow", "Depressed or Not"))
        self.LB_Pearson.setStatusTip(_translate("MainWindow", "Depressed or Not"))
        self.LB_Pearson.setWhatsThis(_translate("MainWindow", "Depressed or Not"))
        self.LB_Pearson.setText(_translate("MainWindow", "Depressed or Not"))
        #--------------------------------------------------------------------------------------------------
